        ...
        {isOpen && (
          <div className="md:hidden py-3 border-t">
            ...
            <div className="mt-4 pt-4 border-t">
              <p className="px-3 text-xs font-semibold text-gray-500 mb-2">🌐 RECURSOS EXTERNOS</p>
              {externalLinks.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
            ...
            <div className="mt-4 pt-4 border-t">
              <a
                href="/admin"
                className="flex items-center space-x-2 px-3 py-2 rounded hover:bg-gray-100 text-gray-500"
                onClick={() => setIsOpen(false)}
              >
                <Lock size={14} />
                <span>Admin</span>
            ...
            <div className="mt-4 px-3">
              <a
                href="tel:911"
                className="flex items-center justify-center space-x-2 bg-red-600 text-white px-4 py-3 rounded-lg font-bold"
              >
